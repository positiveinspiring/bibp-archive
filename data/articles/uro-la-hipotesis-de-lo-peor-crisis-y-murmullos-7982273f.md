...
> Source: https://www.bibliotecapleyades.net/Sociopolitica/sociopol_globalbanking149.htm
...
non-idea, one which is fundamentally ideological by its nature
a
...
their own currency.
Now, dont start imagining for one second that some kind
...
clean up Manhattan?
The other voice belongs to those who call the shots
in short, the managers
...
result of the economic machine gone awry
In short, that its nobodys
...
Lets add that the financial chaos, monetary and economic, on both sides of
the Atlantic is an undeniable windfall, for those who prosper in the
backwash of the markets trajectory, provoking and anticipating the cycles
...
constitutes a mixture that promises to blow up in ones face.
An observation
...
For its a risk worth taking if in the end Europe finds itself on its knees.
